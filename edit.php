        ...
        <div class="row">
            <form action="proccess.php" method="POST" class="col">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="url" name="img" value="<?php echo $img; ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group row" style="margin-left: 16%; margin-top: 4%;">
                    <div class="col-10">
                        <?php if ($update == true): ?>
                            <input type="submit" name="edit" value="Edit" class="btn btn-lg" style="background-color: rgb(35, 219, 201); color: white;">
                        <?php endif; ?>
                    </div>
                </div>
            </form>
